...
var PROJECT_SCHEMA_DEFINITIONS = {"AUDIT_LOGS":{"entity":"AUDIT_LOGS","sheetName":"Audit_Logs","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"baseline"},"BIOMASSA":{"entity":"BIOMASSA","sheetName":"Biomassa_Produtividade","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Config.gs"},"CANTEIROS":{"entity":"CANTEIROS","sheetName":"Canteiros","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Config.gs"},"CORE":{"entity":"CORE","sheetName":"Core","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Db_Core.gs"},"ELETROMA":{"entity":"ELETROMA","sheetName":"Eletroma_Sinais","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Config.gs"},"LEITURAS":{"entity":"LEITURAS","sheetName":"Leituras_Sensores","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Config.gs"},"NDVI":{"entity":"NDVI","sheetName":"Ndvi","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Db_NDVI.gs"},"NDVI_LOGS":{"entity":"NDVI_LOGS","sheetName":"Ndvi_Logs","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"Db_NDVI.gs"},"SETTINGS":{"entity":"SETTINGS","sheetName":"Settings","headers":["Key","Value","Description","Scope","UpdatedAt","UpdatedBy"],"required":["Key"],"identifier":"Key","source":"baseline"},"USERS":{"entity":"USERS","sheetName":"Users","headers":["ID","Name","Email","Username","PasswordHash","Role","Status","LastLoginAt","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"baseline"},"USUARIOS":{"entity":"USUARIOS","sheetName":"Usuarios","headers":["ID","Name","Email","Username","PasswordHash","Role","Status","LastLoginAt","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Config.gs"},"XAI":{"entity":"XAI","sheetName":"Xai","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Db_XAI.gs"},"XAI_LOGS":{"entity":"XAI_LOGS","sheetName":"XAI_Explicabilidade","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"Config.gs"}};
...
var SYNTHETIC_USERS_LOGIN_SCHEMAS = [
  { sheetName: 'Usuarios', headers: ['ID','Username','Password','Role','Name','Email','Senha'] }
];
