 ...
 * ============================================================================
 * PROJETO: Sutiliza - Eletrocultura
 * TEMA: Eletrocultura e agricultura experimental
 *
 * DESCRIÇÃO:
...
var THEME_NEWS_CFG = {
  THEME: 'Eletrocultura e agricultura experimental',
  QUERY: 'eletrocultura OR "agricultura experimental"',
  AUDIENCE: 'estudantes que comparam os canteiros Controle, Cobre Passivo e PEMF Ativo no experimento de eletrocultura',
